...
public class LoginPassword : MonoBehaviour
{
    #region variables
    [Header("Login")]
    public TMP_InputField _auth_email;
    public TMP_InputField _auth_password;

    [Header("Sign up")]
    public TMP_InputField _reg_email;
    public TMP_InputField _reg_password;
    public TMP_InputField _reg_confirmPassword;

    [Header("Extra")]
    public TextMeshProUGUI _loginText;
    public GameObject _loginUi, _signupUi,_lowerGroup;
    #endregion
    ...
    public void SignUp()
    {
        ...
        string email = _reg_email.text;
        string password = _reg_password.text;
        auth.CreateUserWithEmailAndPasswordAsync(email, password).ContinueWithOnMainThread((System.Action<System.Threading.Tasks.Task<AuthResult>>)(task => {
            if (task.IsCanceled)
            {
    ...
    {
        FirebaseAuth auth = FirebaseAuth.DefaultInstance;
        string email = _auth_email.text;
        string password = _auth_password.text;

        Credential credential =
        EmailAuthProvider.GetCredential(email, password);
        auth.SignInAndRetrieveDataWithCredentialAsync(credential).ContinueWithOnMainThread((System.Action<System.Threading.Tasks.Task<AuthResult>>)(task => {
            if (task.IsCanceled)
            {
